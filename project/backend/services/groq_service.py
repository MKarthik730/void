...
SYSTEM_PROMPT = (
    "You are VOID, an intelligent AI screen assistant. Be concise, clear, and helpful."
)
...
def analyze(screenshot_b64: str, action: str) -> str:
    ...
    try:
        ...
        return f"ERROR: Groq vision analysis failed - {str(e)}"
...
def describe_image(screenshot_b64: str, user_question: str = "") -> str:
    ...
    try:
        ...
        return f"ERROR: Groq image description failed - {str(e)}"
